...
import newfetch.HttpClientUtil;
...
public class FetchUrlThread extends Thread{
    String dbNamePre = "tianyanew";
//    private LinkedBlockingQueue<HashMap<String,String>> queue;
//    public FetchUrlThread(LinkedBlockingQueue<HashMap<String,String>> queue) {
//        this.queue = queue;
//    }
    ...
    public void run() {
        ...
        // URL指向要访问的数据库名scutcs
        String url = "jdbc:mysql://127.0.0.1:3306/"+dbNamePre+board+"?useUnicode=true&characterEncoding=UTF-8";
        // MySQL配置时的用户名
        String user = "root";
        // MySQL配置时的密码
        String password = "1";
...
//                                            System.out.println(updateSql);
            ...
            String insertSql = "replace INTO viewPostbak (initiatePostId,viewTime,crawlTime,floorIndex) VALUES(?,?,?,?);";
...
//                                            viewTimsList.add(replytime);
                                            ...
                                            int floorIndex = 0;
                                            if (hrefs.size()==2){
                                                String temp = hrefs.last().attr("floor");
                                                if (temp!=null){
                                                    floorIndex = Integer.parseInt(temp);
                                                }
                                            }
                                            ...
                                            if (needUpdate){
                                                ...
                                                updateInitiateTime.setString(1,replytime);
